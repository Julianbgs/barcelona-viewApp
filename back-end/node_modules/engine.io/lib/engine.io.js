 ...
 *
 * @param {http.Server} back-end (if specified, will be attached to by the new Server instance)
 * @param {Object} options
 * @return {Server} engine back-end
 * @api public
 */

exports = module.exports = function () {
  // backwards compatible use as `.attach`
  // if first argument is an http back-end
  if (arguments.length && arguments[0] instanceof http.Server) {
    return attach.apply(this, arguments);
  }

  // if first argument is not an http back-end, then just make a regular eio back-end
 ...
 * @param {Object} options
 * @return {Server} websocket.io back-end
 * @api public
 */
