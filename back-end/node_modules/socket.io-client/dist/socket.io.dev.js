...
/***/ (function(module, exports, __webpack_require__) {
	...
	Socket.prototype.onPacket = function (packet) {
	  if ('opening' === this.readyState || 'open' === this.readyState ||
	    ...
	    switch (packet.type) {
	      ...
	      case 'error':
	        var err = new Error('back-end error');
	...
	/**
	 * Pings back-end every `this.pingInterval` and expects response
...
/***/ (function(module, exports, __webpack_require__) {
	...
	JSONPPolling.prototype.doWrite = function (data, fn) {
	  ...
	  // double escaping is required for escaped new lines because unescaping of new lines can be done safely on back-end-side
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/**
	 * Called upon a back-end acknowlegement.
	 *
	 * @param {Object} packet
	 * @api private
	 */
	...
	/**
	 * Called upon back-end disconnect.
	 *
	 * @api private
	 */
	
	Socket.prototype.ondisconnect = function () {
	  debug('back-end disconnect (%s)', this.nsp);
	  this.destroy();
	  this.onclose('io back-end disconnect');
	};
	
	/**
	 * Called upon forced client/back-end side disconnections,
