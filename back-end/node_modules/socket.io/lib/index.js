...
var debug = require('debug')('socket.io:back-end');
var url = require('url');
 ...
 * Server constructor.
 *
 * @param {http.Server|Number|Object} srv http back-end, port or options
 * @param {Object} [opts]
 * @api public
 */
...
/**
 * Executes the middleware for an incoming namespace not already created on the back-end.
 *
...
/**
 * Attaches socket.io to a back-end or port.
 *
 * @param {http.Server|Number} back-end or port
...
Server.prototype.attach = function(srv, opts){
  ...
  if ('number' == typeof srv) {
    debug('creating http back-end and binding to %d', srv);
    var port = srv;
 ...
 *
 * @param {Function|http.Server} srv http back-end
 * @api private
 */
 ...
 *
 * @param {engine.Server} engine engine.io (or compatible) back-end
 * @return {Server} self
 * @api public
 */
